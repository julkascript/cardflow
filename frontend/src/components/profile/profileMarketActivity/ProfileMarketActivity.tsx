      ...
      <section>
        <table className="border-stone-300 bg-white border-spacing-0 border-separate rounded-lg border-2 w-full">
          ...
          <tbody>
            ...
            <tr>
              <MarketActivityTableCell heading="Sales This Month" data={props.user.stats.sales_this_month} />
              <MarketActivityTableCell heading="Seller Rating" data={`${props.user.stats.seller_rating}/5`} />
            </tr>
            <tr>
              <MarketActivityTableCell heading="Rejection Rate" data={`${props.user.stats.rejection_rate}%`} />
