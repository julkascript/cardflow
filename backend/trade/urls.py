...
urlpatterns = [
    ...
    path('<int:pk>/negotiate/', TradeListingViewSet.as_view({'put': 'negotiate'}), name='trade_negotiate'),
    path('<int:pk>/accept/', TradeListingViewSet.as_view({'put': 'accept'}), name='trade_accept'),
    path('<int:pk>/reject/', TradeListingViewSet.as_view({'put': 'reject'}), name='trade_reject'),
